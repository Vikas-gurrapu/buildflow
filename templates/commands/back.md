...
Before listing or using git restore points, read `.buildflow/PREFERENCES.md`.
...
## Step 5: Update State
Update `.buildflow/STATE.md` to reflect restored phase.
Update `.buildflow/MEMORY.md` to match.
