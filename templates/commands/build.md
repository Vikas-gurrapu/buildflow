...
6. Update `.buildflow/epics/[epic]/VERIFICATION.md` for the linked ACs:
...
Update `.buildflow/epics/[epic]/VERIFICATION.md` before moving to the next wave:
...
After final integration check, update `.buildflow/epics/[epic]/VERIFICATION.md`:
